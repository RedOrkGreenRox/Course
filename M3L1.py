...
#
#
# a = Item('VideoCard', 45000, 0.3)
# b = Item('Processor', 30000, 0.1)
# c = Item('Operative', 20000, 0.1)
# print(a + (b + c))    # Теория занятия
# Игра
...
class Aer:
    ...
    def __add__(self, other):
        if isinstance(other, Ignis):
            ...
            return Auram()
        elif isinstance(other, Aer or Volatus or Potentia):
            return Ventus()
